						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-desktop"></i> Messages <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="{{route('listMessages')}}">Messages List</a></li>
									</ul>
								</li>
							</ul>
						</div>
                ...
                <ul class=" navbar-right">
                  ...
                  <li role="presentation" class="nav-item dropdown open">
                    ...
                    <ul class="dropdown-menu list-unstyled msg_list" role="menu" aria-labelledby="navbarDropdown1">
                      ...
                      <li class="nav-item">
                        <a class="dropdown-item" href="/admin/messageShow/{{$notification->data['msg_id']}}" style="text-decoration:none; color:inherit;">
                      ...
                      <li class="nav-item">
                        <div class="text-center">
                          <a class="dropdown-item" href="/admin/messages" style="text-decoration:none; color:inherit;">
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Manage <small>@yield('title2')</small></h3>
              </div>
