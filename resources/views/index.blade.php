...
@if(Session::has('success'))
  ...
  <div class="tm-container">
    <div class="tm-row">
      ...
      <div class="tm-right">
      @if(Auth::check())
        <button type="button" style="background-color:black ; width:250px; height:50px; font-size: 20px; opacity: 0.5;"><p style="color: white;">{{Auth::user()->name}}</p></button>
        <button type="button" style="background-color:black ; width:120px; height:50px; font-size: 25px; opacity: 0.5;"><a style="color:white;" href="{{route('adminLogout')}}">Logout</a></button>
      
      @else
      <button type="button" style="background-color:black ; width:120px; height:50px; font-size: 25px; opacity: 0.5;"><a style="color:white;" href="{{ route('login')}}">Login</a></button>
      <button type="button" style="background-color:black ; width:120px; height:50px; font-size: 25px; opacity: 0.5;"><a style="color:white;"  href="{{ route('register')}}">Sign up</a></button>
      ...
      <main class="tm-main">
          <div id="drink" class="tm-page-content">
            ...
            <nav class="tm-black-bg tm-drinks-nav">
              <ul>
                ...
                <li>
                  <a href="#" class="tm-tab-link active" data-id="{{$category->id}}">{{$category->category_name}}</a>
                </li>
                <li>
                  @endforeach
            ...
            @if($beverage->published=='yes')
              <div class="tm-list">
                <div class="tm-list-item">          
                  <img src="images/{{$beverage->image}}" alt="Image" class="tm-list-item-img">
          ...
          <div id="special" class="tm-page-content">
            <div class="tm-special-items">
              ...
              <div class="tm-black-bg tm-special-item">
                <img src="images/{{$sp->image}}" alt="Image">
          ...
          <div id="contact" class="tm-page-content">
            <div class="tm-black-bg tm-contact-text-container">
              ...
              <p> Please contact us if you have any complaint. Tell your friends about our website.</p>
            </div>
            ...
            <div class="tm-black-bg tm-contact-form-container tm-align-right">
              ...
              <form action="{{route('sendMail')}}" method="POST" id="contact-form">
                ...
                <div class="tm-form-group">
                  <input type="text" name="name" value="{{old('name')}}" class="tm-form-control @error('name') is-invalid @enderror" placeholder="Name"  />
                </div>
                @error('name')
                                             <div class="alert alert-danger">{{$message}}</div> 
			                                @enderror
                <div class="tm-form-group">
                  <input type="email" name="email" value="{{old('email')}}" class="tm-form-control @error('email') is-invalid @enderror" placeholder="Email" />
                </div> 
                @error('email')
                                             <div class="alert alert-danger">{{$message}}</div> 
			                                @enderror       
                <div class="tm-form-group tm-mb-30">
                  <textarea rows="6" name="message" value="{{old('message')}}" class="tm-form-control @error('message') is-invalid @enderror" placeholder="Message" ></textarea>
                </div>  
                @error('message')
                                             <div class="alert alert-danger">{{$message}}</div> 
			                                @enderror      
